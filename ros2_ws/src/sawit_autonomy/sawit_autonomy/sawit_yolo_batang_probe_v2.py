...
class YoloBatangTest(Node):
    def __init__(self) -> None:
        ...
        self.get_logger().info("START YOLO-BATANG PROBE V2 (full-frame + tiled inference, drone tidak digerakkan)")
        ...
        try:
            ...
            if not self.logged_image_info:
                ...
                self.get_logger().info(
                    f"INPUT_IMAGE topic={self.image_topic} encoding={self.latest_image.encoding} "
            ...
            if now - self.last_summary_time >= 1.0:
                ...
                if detections:
                    ...
                    self.get_logger().info(f"YOLO_BATANG detections=0 stable=0 max_raw_conf={max_raw_conf:.4f}")
