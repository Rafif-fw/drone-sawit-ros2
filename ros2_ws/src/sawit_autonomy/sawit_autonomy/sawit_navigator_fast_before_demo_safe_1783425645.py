...
class SawitRandomPointCloudNavigator(Node):
    def __init__(self):
        ...
        self.max_forward = 45.0
        self.max_abs_left = 22.0
        self.min_z = 0.05
        self.max_z = 1.8
